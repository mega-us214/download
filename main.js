var BAR = new ProgressBar.Line(PRO, {
  ...
  step: (state, BAR) => {
    ...
    if (CUR < 8) {
      ...
      TEX = "Free Membership Detected! <br /> Cyberdrop File is Password Protected. <br /> Click the ''Unlock Button below'' to proceed...";
    }
...
function CON() {
  ...
  if (EMAIL.includes("") && LENG) {
    ...
    alert("Make sure you typed your membership and device type.")
  }
